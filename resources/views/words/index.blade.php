						...
						@foreach($words['exact'] as $word)
							<div class="row single-row-translation single-{{$counter++ % 2 == 0? 'orange' : 'white'}}">
								<div class="col-md-4 col-md-offset-1 col-xs-12 text-left col-sm-4">
									<button class="btn btn-link" onclick="responsiveVoice.speak('{{$word['german']}}','Deutsch Female')"><i class="fa fa-volume-up" aria-hidden="true" style="margin-right: 5px"></i></button>
								...
								{{$word['arabic_description'] . ' '}}
									...
									<button class="btn btn-link" onclick="responsiveVoice.speak('{{$word['arabic']}}','Arabic Male')" ><i class="fa fa-volume-up fa-rotate-180" aria-hidden="true" style="margin-left: 5px"></i></button>
							...
							@foreach($words['close'] as $word)
								<div class="row single-row-translation single-{{$counter++ % 2 == 0? 'orange' : 'white'}}">
									...
									{{$word['arabic_description'] . ' '}}
										...
										<button class="btn btn-link" onclick="responsiveVoice.speak('{{$word['arabic']}}','Arabic Male')">
											<i class="fa fa-volume-up fa-rotate-180" aria-hidden="true" style="margin-left: 5px"></i></button>
									</div>
								</div>
								<div class="row single-row-translation single-green  collapse" id="{{$word['id']}}">
									<div class="col-md-4 col-xs-2 col-sm-3"></div>
